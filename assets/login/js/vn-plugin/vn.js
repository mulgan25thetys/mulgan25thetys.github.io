...
;(function ($) {
    ...
    $(function () {
        ...
        pNumPricesObj.updatePNumSPrices = function (e) {
            ...
            if ( setupFee ) {
                pNumPricesObj.$pNumSetupFee.html('<td>Frais d\'installation uniques</td><td data-price="' + setupFee + '">€' + setupFee.toFixed(2) + '</td>');
            } else {
                pNumPricesObj.$pNumSetupFee.empty();
            }
            
            if ( monthlyFee ) {
                pNumPricesObj.$pNumMonthlyFee.html('<td>Redevance Mensuelle</td><td data-price="' + monthlyFee + '">€' + monthlyFee.toFixed(2) + '</td>');
            } else {
            ...
            if ( inCallsPrice ) {
                ...
                pNumPricesObj.$pNumInCallsPrice.html('<td>Appels entrants (<span class="PNumCallFMinutes">' + inCallsMinutes + '</span> minutes)</td><td data-price="' + inCallsPrice + '">€' + inCallsPrice.toFixed(2) + '</td>');
        ...
        pNumPricesObj.updateCallFPrices = function (e) {
            ...
            if ( parseFloat( value ) === 0 ) {
                ...
                pNumPricesObj.$callFPrice.html('<td>Renvoi d\'appel (<span class="PNumCallFMinutes">' + cFMinutes + '</span> minutes)</td><td data-price="' + cFValue + '">€' + cFValue.toFixed(2) + '</td>');
