...
<![endif]-->
		...
		<script src="<?= base_url()?>assets/theme_crm/js/bootstrap.min.js"></script>
		...
		<![endif]-->
		<script src="<?= base_url()?>assets/theme_crm/js/jquery-ui.custom.min.js"></script>
		<script src="<?= base_url()?>assets/theme_crm/js/jquery.ui.touch-punch.min.js"></script>
		<script src="<?= base_url()?>assets/theme_crm/js/jquery.easypiechart.min.js"></script>
		<script src="<?= base_url()?>assets/theme_crm/js/jquery.sparkline.index.min.js"></script>
		<script src="<?= base_url()?>assets/theme_crm/js/jquery.flot.min.js"></script>
		<script src="<?= base_url()?>assets/theme_crm/js/jquery.flot.pie.min.js"></script>
		<script src="<?= base_url()?>assets/theme_crm/js/jquery.flot.resize.min.js"></script>

		<!-- ace scripts -->
		<script src="<?= base_url()?>assets/theme_crm/js/ace-elements.min.js"></script>
		<script src="<?= base_url()?>assets/theme_crm/js/ace.min.js"></script>
